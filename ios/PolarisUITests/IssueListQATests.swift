...
final class IssueListQATests: XCTestCase {
    ...
    func testListHeaderOrderingFilterAndRefresh() {
        ...
        XCTAssertEqual(eyebrowLabel(app)?.uppercased(), "3 OPEN", "three open issues")
        ...
        XCTAssertEqual(
            eyebrowAfter?.uppercased(), "3 OPEN",
    ...
    func testStatusChangeOnDetailReachesTheList() {
        ...
        XCTAssertEqual(eyebrowAfter?.uppercased(), "2 OPEN", "the open count should drop from 3 to 2")
    }
    ...
    func testEmptyState_EverythingCompleted_QAFixtures() {
        ...
        XCTAssertEqual(eyebrowLabel(app)?.uppercased(), "0 OPEN", "nothing is open")
    }
