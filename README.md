...
| Working | |
|---|---|
| Schema | 35 migrations, including project labels, attached project views, project dependencies, project updates, initiatives, documents, webhooks, attachments, auto-close/archive, triage, cycles, projects, statuses, teams, members and milestones; monthly-partitioned change log, UUIDv7 |
...
| Client store | IndexedDB replica (schema 14), in-memory indexes, durable outbox, optimistic mutations |
