...
**Cycles v1**, **Triage v1**, **Archives v1** and **Attachments v1** (the first slices of Milestone 2).

## What runs today

Backend and web client are both complete through Milestone 1 and tested end to end, in the browser as well as in unit tests. Projects v1, Cycles v1, Peek, Triage v1, Archives v1 and Attachments v1 sit on the same visual system as the rest of the web app (dense list/detail, compact pickers, command menu). The desktop shell packages and runs on macOS, Windows and Linux.

| Working | |
|---|---|
| Schema | 28 migrations, including attachments, auto-close/archive, triage, cycles, projects, statuses, teams, members and milestones; monthly-partitioned change log, UUIDv7 |
