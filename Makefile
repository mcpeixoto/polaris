...
.PHONY: lint
lint: lint-go lint-breakpoints lint-compose lint-desktop lint-editions lint-images lint-imports lint-ios-graphql lint-keymap lint-release lint-routes lint-workflow-vars lint-tokens lint-web ## All linters
