...
const HEADING_FROM_A_WRAPPER: Record<string, string> = {
  ...
  InitiativeShell: 'renders the initiative name as h1 for nested tabs',
  InitiativeDetail: 'InitiativeShell renders the h1 for nested initiative tabs',
  InitiativeActivity: 'InitiativeShell renders the h1 for nested initiative tabs',
