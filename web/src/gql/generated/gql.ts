...
type Documents = {
    ...
    "\n  fragment ReactionFields on Reaction {\n    id\n    workspaceId\n    commentId\n    userId\n    emoji\n    createdAt\n  }\n": typeof types.ReactionFieldsFragmentDoc,
...
const documents: Documents = {
    ...
    "\n  mutation BulkUpdateIssues($input: BulkUpdateIssuesInput!, $clientId: UUID!, $opId: UUID!) {\n    bulkUpdateIssues(input: $input, clientId: $clientId, opId: $opId) {\n      version\n      skipped {\n        id\n        reason\n      }\n    }\n  }\n": types.BulkUpdateIssuesDocument,
    ...
    "\n  \n  mutation CreateProjectMilestone(\n    $input: CreateProjectMilestoneInput!\n    $clientId: UUID\n    $opId: UUID\n  ) {\n    createProjectMilestone(input: $input, clientId: $clientId, opId: $opId) {\n      version\n      milestone {\n        ...ProjectMilestoneFields\n      }\n    }\n  }\n": types.CreateProjectMilestoneDocument,
    "\n  \n  mutation UpdateProjectMilestone(\n    $input: UpdateProjectMilestoneInput!\n    $clientId: UUID\n    $opId: UUID\n  ) {\n    updateProjectMilestone(input: $input, clientId: $clientId, opId: $opId) {\n      version\n      milestone {\n        ...ProjectMilestoneFields\n      }\n    }\n  }\n": types.UpdateProjectMilestoneDocument,
    "\n  mutation DeleteProjectMilestone($id: UUID!, $clientId: UUID, $opId: UUID) {\n    deleteProjectMilestone(id: $id, clientId: $clientId, opId: $opId) {\n      version\n      id\n    }\n  }\n": types.DeleteProjectMilestoneDocument,
