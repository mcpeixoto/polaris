...
export type SlackConnectionFieldsFragment = { id: string, workspaceId: string, creatorId: string, enabled: boolean, defaultTeamId: string, channelName?: string | null, notifyIssues: boolean, notifyComments: boolean, connectedAt?: string | null, createdAt: string, updatedAt: string };
...
export type CreateSlackConnectionMutation = { createSlackConnection: { version: number, slackConnection: { id: string, workspaceId: string, creatorId: string, enabled: boolean, defaultTeamId: string, channelName?: string | null, notifyIssues: boolean, notifyComments: boolean, connectedAt?: string | null, createdAt: string, updatedAt: string } } };
...
export type UpdateSlackConnectionMutation = { updateSlackConnection: { version: number, slackConnection: { id: string, workspaceId: string, creatorId: string, enabled: boolean, defaultTeamId: string, channelName?: string | null, notifyIssues: boolean, notifyComments: boolean, connectedAt?: string | null, createdAt: string, updatedAt: string } } };
...
export type IssueTemplateFieldsFragment = { id: string, workspaceId: string, teamId?: string | null, name: string, description?: string | null, title: string, body: string, properties: unknown, position: string, createdBy?: string | null, createdAt: string, updatedAt: string, archivedAt?: string | null, emailIntakeEnabled: boolean, emailIntakeAddress?: string | null };
...
export type CreateIssueTemplateMutation = { createIssueTemplate: { version: number, template: { id: string, workspaceId: string, teamId?: string | null, name: string, description?: string | null, title: string, body: string, properties: unknown, position: string, createdBy?: string | null, createdAt: string, updatedAt: string, archivedAt?: string | null, emailIntakeEnabled: boolean, emailIntakeAddress?: string | null } } };
...
export type UpdateIssueTemplateMutation = { updateIssueTemplate: { version: number, template: { id: string, workspaceId: string, teamId?: string | null, name: string, description?: string | null, title: string, body: string, properties: unknown, position: string, createdBy?: string | null, createdAt: string, updatedAt: string, archivedAt?: string | null, emailIntakeEnabled: boolean, emailIntakeAddress?: string | null } } };
...
export type UpdateIssueTemplateEmailIntakeMutation = { updateIssueTemplateEmailIntake: { version: number, template: { id: string, workspaceId: string, teamId?: string | null, name: string, description?: string | null, title: string, body: string, properties: unknown, position: string, createdBy?: string | null, createdAt: string, updatedAt: string, archivedAt?: string | null, emailIntakeEnabled: boolean, emailIntakeAddress?: string | null } } };
...
export const CreateProjectTemplateMilestoneDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateProjectTemplateMilestone"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateProjectTemplateMilestoneInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createProjectTemplateMilestone"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"milestone"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ProjectTemplateMilestoneFields"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ProjectTemplateMilestoneFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ProjectTemplateMilestone"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"workspaceId"}},{"kind":"Field","name":{"kind":"Name","value":"projectTemplateId"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"targetDate"}},{"kind":"Field","name":{"kind":"Name","value":"sortOrder"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<CreateProjectTemplateMilestoneMutation, CreateProjectTemplateMilestoneMutationVariables>;
