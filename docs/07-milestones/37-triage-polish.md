# Triage polish (8.1 remainder)

**Status:** shipped on this branch  
**Migration:** none  
**Client schema:** 44 (unchanged)

Triage v1 already accepted, declined, merged and snoozed. This is the rest of the inbox
ergonomics Linear documents next to those keys.
